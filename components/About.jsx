      ...
      <div className="text-primary md:flex">
        <div className="">
          <p className="text-lg my-3">
            ...
            web developer.
            <br />
            After more than 5 years working in the music industry, i decided to
            pursue a new path in tech.
            ...
            assistant. A little while ltaer, I started working as freelance full
            stack developer for a startup, which allowed to build a confidence
            in my new skills acquired. This project is now completed, I am
            tehrefore looking to find a new position where I can continue to
          ...
          <div className="md:columns-2 lg:columns-3">
            ...
            <p className="font-semibold">
              Phone: <span className="font-normal">+32 (0) 4 73 32 95 56</span>
            </p>
            <p className="font-semibold">
              Location: <span className="font-normal">Brussels, Belgium</span>
            </p>
            <p className="font-semibold">
              Birthday: <span className="font-normal">25th February 1997</span>
            </p>
            <p className="font-semibold">
              Email:{' '}
              <span className="font-normal">thomasallenmartinho@gmail.com</span>
            </p>
            <p className="font-semibold">
              Availability:{' '}
