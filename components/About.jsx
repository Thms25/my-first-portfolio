          ...
          <div className="">
            <Reveal dly={0.4} duration={1} initY={-30}>
              <p className="text-lg my-3">
                ...
                startup working on a SaaS product, collaborating closely with
                data engineers. Leveraging my prior experience in sound
                engineering, I brought a unique perspective to the team,
                emphasising professionalism, adaptability, creativity and
                team-work.
                <br />I am always looking to find a new exciting project where I
                can continue to learn and grow as a developer, feel free to
            ...
            <Reveal dly={0.6} duration={1.5} initY={80}>
              <div className="md:columns-2 lg:columns-3">
                ...
                <p className="font-semibold">
                  Location:{' '}
                  <span className="font-normal">Brussels, Belgium</span>
                </p>
                <p className="font-semibold">
                  Age:{' '}
                ...
                <p className="font-semibold">
                  Availability:{' '}
                  <span className="font-normal">January 2025</span>
                </p>
              </div>
            </Reveal>
          </div>
